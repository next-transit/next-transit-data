...
function get_stop_by_direction(agency_id, first, route, direction_id) {
  return new promise(function(resolve, reject) {
    ...
    simplified_stops.query().error(reject)
...
function generate_directions(agency_id) {
  return new promise(function(resolve, reject) {
    routes
      .query(agency_id)
      .error(reject)
...
module.exports = function(model) {
  ...
  directions = model.create('route_directions');
  directions.generate_directions = generate_directions;
  return directions;
};

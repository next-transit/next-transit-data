...
display_trips.get_by_time = function(agency, is_rail, route_id, direction_id, from_id, offset, to_id) {
  return new promise(function(resolve, reject) {
    stop_times.get_by_time(agency, is_rail, route_id, direction_id, from_id, offset).then(function(times) {
      convert_list(agency, times, to_id, function(trips) {
        resolve(trips);
      });
    }, reject);
